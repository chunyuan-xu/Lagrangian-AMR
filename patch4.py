...
# Inject p4est_data ONLY in write_solution
write_sol_start = content.find('static void write_solution(p4est_t *p4est')
if write_sol_start != -1:
    part1 = content[:write_sol_start]
    part2 = content[write_sol_start:]
    part2 = re.sub(r'(char\s+filename\[BUFSIZ\] = "";)', r'\1\n\tp4est_data_t\t\t*p4est_data = (p4est_data_t *)p4est->user_pointer;', part2, count=1)
    content = part1 + part2
