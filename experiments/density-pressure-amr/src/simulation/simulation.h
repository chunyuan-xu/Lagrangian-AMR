...
#include "diagnostics/noh_localization_audit.h"
#include "diagnostics/final_topology_audit.h"
...
void advance_time_step(p4est_t * p4est, double start_time, double end_time)
{
	...
	for (t = start_time; t < end_time; t += p4est_data->delta_time)
	{
        ...
        RefreshGeometryAudit::capture(p4est);
		AMRCallbacks::refresh_after_balance(p4est, ghost_session);
        DerivedStateExperiment::record(p4est,"after_refresh");
        DerivedStateExperiment::synchronize(p4est);
        DerivedStateExperiment::record(p4est,"after_sync");
        RefreshGeometryAudit::finish(p4est);
        OverlapRemapExperiment::finish(p4est);
        ...
        NohLocalizationAudit::record(p4est,"refreshed");
        ...
        DerivedStateExperiment::record(p4est,"accepted");
        ...
        NohLocalizationAudit::record(p4est,"accepted");
    ...
    FinalTopologyAudit::record(p4est);
