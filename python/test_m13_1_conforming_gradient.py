"""M13.1 micro-gate: conforming two-cell gradient kernel."""
...
DEFAULT_SUMMARY = ROOT / ".tmp" / "mg-m13-1-conforming-gradient.json"
...
int main()
{
    ...
    CDoubleVector b(2.0, 0.0);
    double g = AMRCallbacks::conforming_gradient(1.0, 3.0, a, b);
...
def main():
    ...
    summary = {
        "schema": "lagrangian-amr.micro-gate.m13-1-conforming-gradient.v1",
    ...
    with tempfile.TemporaryDirectory(prefix="m13-1-", dir=ROOT / ".tmp") as directory:
    ...
    args.summary.write_text(json.dumps(summary, indent=2) + "\n", encoding="utf-8")
    print(f"MG-M13-1 {summary['status']}: {args.summary}")
