"""E1b micro-gate: DBGF orchestration unreachable stub."""
...
DEFAULT_SUMMARY = ROOT / ".tmp" / "mg-e1b-dbgf-orchestration.json"
...
def main():
    ...
    summary = {
        "schema": "lagrangian-amr.micro-gate.e1b-dbgf-orchestration.v1",
        "started_at": datetime.now().astimezone().isoformat(),
        "unreachable_stub": True,
        "status": "ERROR",
    }
    if not CXX.exists():
        ...
        return 2
    with tempfile.TemporaryDirectory(prefix="e1b-dbgf-", dir=ROOT / ".tmp") as directory:
